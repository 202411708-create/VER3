    ...
    >
      <div className="max-w-3xl w-full">
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-muji-dark mb-3">
            🔍 시간탐정
          </h1>
          <p className="text-xl text-muji-mid">나의 시간을 찾아라</p>
        </div>
        ...
        <Card padding="lg" className="mb-8 bg-muji-beige border-muji-mid">
          <h3 className="text-lg font-bold text-muji-dark mb-4">참여 방법</h3>
